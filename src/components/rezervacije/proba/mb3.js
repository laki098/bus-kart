...
const MB3 =({ onReservation, linijaId, pocetnaStanicaId,
  krajnjaStanicaId, })=> {
...
const isSeatReserved = (seatNumber) => {
  ...
  return (
    <div className="container-seat">
      ...
      <div className="row">
      <div
          className={`seat1 ${isSeatSelected(47) || isSeatReserved(47) ? "disabled" : ""}`}
        ...
        <div
          className={`seat1 ${isSeatSelected(48) || isSeatReserved(48) ? "disabled" : ""}`}
