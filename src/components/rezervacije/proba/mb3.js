...
>
  <span className="seat-number2">{isSeatSelected(1) ? "" : "1"}</span>
      ...
      <div className="row">
        <div
          className={`seat1 ${isSeat1Selected(47) ? "selected" : ""}`}
          onClick={() => handleSeat1Click(47)}
        ><span className="seat-number1">{isSeatSelected(47) ? "" : "47"}</span></div>
        <div
          className={`seat1 ${isSeat1Selected(48) ? "selected" : ""}`}
          onClick={() => handleSeat1Click(48)}
        ><span className="seat-number1">{isSeatSelected(48) ? "" : "48"}</span></div>
        <div
          className={`seat1 ${isSeat1Selected(49) ? "selected" : ""}`}
          onClick={() => handleSeat1Click(49)}
        ><span className="seat-number1">{isSeatSelected(49) ? "" : "49"}</span></div>
        <div
          className={`seat1 ${isSeat1Selected(50) ? "selected" : ""}`}
          onClick={() => handleSeat1Click(50)}
        ><span className="seat-number1">{isSeatSelected(50) ? "" : "50"}</span></div>
        <div
