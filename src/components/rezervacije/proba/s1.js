  ...
  return (
    <>
      ...
      <div className="row">
        ...
        <div
          className={`seat1 ${isSeatSelected(50) || isSeatReserved(50) ? "disabled" : ""}`}
      ...
      {trenutniSprat === "donji" && (
        <div className="container-seat">
          ...
          <div className="row">
          <div
          className={`seat left ${isSeatSelected(74) || isSeatReserved(74) ? "disabled" : ""}`}
        ...
        <div
          className={`seat left ${isSeatSelected(75) || isSeatReserved(75) ? "disabled" : ""}`}
        ...
        <div
          className={`seat ${isSeatSelected(61) || isSeatReserved(61) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(61)}
          style={{ pointerEvents: isSeatReserved(61) ? "none" : "auto" }}
        >
          <span className="seat-number">{isSeatSelected(61) ? "" : "61"}</span>
        </div>
          </div>
          <div className="row">
          <div
