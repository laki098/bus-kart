...
>
  <span className="seat-number2">{isSeatSelected(1) ? "" : "1"}</span>
      ...
      <div
        ...
        ><span className="seat-number1">{isSeatSelected(21) ? "" : "21"}</span></div>
        <div
      ...
      <div className="row">
        <div
          className={`seat2 ${isSeatSelected(23) ? "selected" : ""}`}
          onClick={() => handleSeatClick(23)}
        ><span className="seat-number1">{isSeatSelected(23) ? "" : "23"}</span></div>
        <div
          className={`seat left1 ${isSeatSelected(24) ? "selected" : ""}`}
