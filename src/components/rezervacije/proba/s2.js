    ...
    <>
      ...
      {trenutniSprat === "gornji" && (
        ...
        >
          ...
          <div className="row">
        <div
          className={`seat1 ${isSeatSelected(5) || isSeatReserved(5) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(5)}
          style={{ pointerEvents: isSeatReserved(5) ? "none" : "auto" }}
        >
          <span className="seat-number1">{isSeatSelected(5) ? "" : "5"}</span>
        </div>
        <div
      ...
      <div className="row">
        ...
        <div
          className={`seat left ${isSeatSelected(8) || isSeatReserved(8) ? "disabled" : ""}`}
      ...
      <div className="row">
        ...
        >
          ...
          <div className="row">
          <div
          className={`seat1 ${isSeatSelected(57) || isSeatReserved(57) ? "disabled" : ""}`}
        ...
        <div
          className={`seat1 ${isSeatSelected(58) || isSeatReserved(58) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(58)}
          style={{ pointerEvents: isSeatReserved(58) ? "none" : "auto" }}
        >
          <span className="seat-number1">{isSeatSelected(58) ? "" : "58"}</span>
        </div>
        <div
        ...
        <div
          className={`seat1 ${isSeatSelected(59) || isSeatReserved(59) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(59)}
          style={{ pointerEvents: isSeatReserved(59) ? "none" : "auto" }}
        >
          <span className="seat-number1">{isSeatSelected(59) ? "" : "59"}</span>
        </div>
        <div
          className={`seat1 ${isSeatSelected(60) || isSeatReserved(60) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(60)}
          style={{ pointerEvents: isSeatReserved(60) ? "none" : "auto" }}
        >
          <span className="seat-number1">{isSeatSelected(60) ? "" : "60"}</span>
        </div>
          </div>
          <img
            src={stepenice}
      ...
      {trenutniSprat === "donji" && (
        <div className="container-seat">
          ...
          <div className="row">
          <div
          className={`seat left ${isSeatSelected(82) || isSeatReserved(82) ? "disabled" : ""}`}
        ...
        <div
          className={`seat left ${isSeatSelected(83) || isSeatReserved(83) ? "disabled" : ""}`}
        ...
        >
          ...
          <div className="row">
          <div
          className={`seat ${isSeatSelected(62) || isSeatReserved(62) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(62)}
          style={{ pointerEvents: isSeatReserved(62) ? "none" : "auto" }}
        >
          <span className="seat-number">{isSeatSelected(62) ? "" : "62"}</span>
        </div>
        <div
          className={`seat ${isSeatSelected(63) || isSeatReserved(63) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(63)}
          style={{ pointerEvents: isSeatReserved(63) ? "none" : "auto" }}
        >
          <span className="seat-number">{isSeatSelected(63) ? "" : "63"}</span>
        </div>
        <div
          className={`seat ${isSeatSelected(64) || isSeatReserved(64) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(64)}
          style={{ pointerEvents: isSeatReserved(64) ? "none" : "auto" }}
        >
          <span className="seat-number">{isSeatSelected(64) ? "" : "64"}</span>
        </div>
        <div
          className={`seat ${isSeatSelected(65) || isSeatReserved(65) ? "disabled" : ""}`}
          onClick={() => handleSeatClick(65)}
          style={{ pointerEvents: isSeatReserved(65) ? "none" : "auto" }}
        >
          <span className="seat-number">{isSeatSelected(65) ? "" : "65"}</span>
        </div>
          </div>
