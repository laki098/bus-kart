  ...
  const handleSeatClick = (seatNumber) => {
    ...
    if (selectedSeats.length > 0) {
      if (selectedSeats != seatNumber) {
        alert(
          "Već ste izabrali sedište. Možete rezervisati samo jedno sedište po putovanju."
        );
        return;
      }
    }
      ...
      {trenutniSprat === "gornji" && (
        <div className="container-seat">
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(4) || isSeatReserved(4) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(3) || isSeatReserved(3) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(1) || isSeatReserved(1) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(2) || isSeatReserved(2) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(5) || isSeatReserved(5) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat1 ${
                isSeatSelected(6) || isSeatReserved(6) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(7) || isSeatReserved(7) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(8) || isSeatReserved(8) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(9) || isSeatReserved(9) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(10) || isSeatReserved(10) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(11) || isSeatReserved(11) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(12) || isSeatReserved(12) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(13) || isSeatReserved(13) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(14) || isSeatReserved(14) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(15) || isSeatReserved(15) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(16) || isSeatReserved(16) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(17) || isSeatReserved(17) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(18) || isSeatReserved(18) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(19) || isSeatReserved(19) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(20) || isSeatReserved(20) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(21) || isSeatReserved(21) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(22) || isSeatReserved(22) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(23) || isSeatReserved(23) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat  ${
                isSeatSelected(24) || isSeatReserved(24) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(25) || isSeatReserved(25) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(26) || isSeatReserved(26) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(27) || isSeatReserved(27) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(28) || isSeatReserved(28) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(29) || isSeatReserved(29) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(30) || isSeatReserved(30) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(31) || isSeatReserved(31) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(32) || isSeatReserved(32) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(33) || isSeatReserved(33) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(34) || isSeatReserved(34) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(35) || isSeatReserved(35) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(36) || isSeatReserved(36) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(37) || isSeatReserved(37) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(38) || isSeatReserved(38) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat1 ${
                isSeatSelected(39) || isSeatReserved(39) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(40) || isSeatReserved(40) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(41) || isSeatReserved(41) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(42) || isSeatReserved(42) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(43) || isSeatReserved(43) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(44) || isSeatReserved(44) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(45) || isSeatReserved(45) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(46) || isSeatReserved(46) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(47) || isSeatReserved(47) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(48) || isSeatReserved(48) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(49) || isSeatReserved(49) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(50) || isSeatReserved(50) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(51) || isSeatReserved(51) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(52) || isSeatReserved(52) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(53) || isSeatReserved(53) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(54) || isSeatReserved(54) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(55) || isSeatReserved(55) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(56) || isSeatReserved(56) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(57) || isSeatReserved(57) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(58) || isSeatReserved(58) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(59) || isSeatReserved(59) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(60) || isSeatReserved(60) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat1 ${
                isSeatSelected(61) || isSeatReserved(61) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat1 ${
                isSeatSelected(62) || isSeatReserved(62) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat1 ${
                isSeatSelected(65) || isSeatReserved(65) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat1 ${
                isSeatSelected(63) || isSeatReserved(63) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat1 ${
                isSeatSelected(64) || isSeatReserved(64) ? "disabled" : ""
              }`}
      ...
      {trenutniSprat === "donji" && (
        <div className="container-seat">
          ...
          <div className="row">
            <div
              className={`seat left ${
                isSeatSelected(90) || isSeatReserved(90) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat left ${
                isSeatSelected(91) || isSeatReserved(91) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(86) || isSeatReserved(86) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(87) || isSeatReserved(87) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(88) || isSeatReserved(88) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(89) || isSeatReserved(89) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(82) || isSeatReserved(82) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(83) || isSeatReserved(83) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(84) || isSeatReserved(84) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(85) || isSeatReserved(85) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(78) || isSeatReserved(78) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(79) || isSeatReserved(79) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(80) || isSeatReserved(80) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(81) || isSeatReserved(81) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(74) || isSeatReserved(74) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(75) || isSeatReserved(75) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(76) || isSeatReserved(76) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(77) || isSeatReserved(77) ? "disabled" : ""
              }`}
          ...
          <div className="row">
            <div
              className={`seat ${
                isSeatSelected(70) || isSeatReserved(70) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(71) || isSeatReserved(71) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(72) || isSeatReserved(72) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(73) || isSeatReserved(73) ? "disabled" : ""
              }`}
          ...
          <div className="row margin">
            <div
              className={`seat ${
                isSeatSelected(66) || isSeatReserved(66) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(67) || isSeatReserved(67) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(68) || isSeatReserved(68) ? "disabled" : ""
              }`}
            ...
            <div
              className={`seat ${
                isSeatSelected(69) || isSeatReserved(69) ? "disabled" : ""
              }`}
