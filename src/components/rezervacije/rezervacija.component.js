    ...
    <>
      ...
      {showReturnDate && (
        <div>
          ...
          { pom ? <div className="maliCrveni" >
            <p > Važi za studente do 27 god. uz index u suprotnom plaća se puna cena</p> </div>
          :" "}
      ...
      <p className="plavo">U slučaju izmene tipa autobusa, moguće je doći do promene rezervacije sedišta, o čemu ćete biti obavešteni. </p>
