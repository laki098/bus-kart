      ...
      <ul>
        <div className={`home-page1 .home-page1 ${showClass ? "show" : ""}`}>
          ...
          <h2 className="card-header">
            ...
            <span className="span"><Trans i18nKey="description.part34"> Red vožnje </Trans></span>
          </h2>
                  ...
                  <div className="travel">
                    ...
                    <div>
                      <Link to={`${linija.id}/rezervacijakarte`}>
                        <button className="buttonSwitch1" style={{fontSize: "1rem"}}>
                        <Trans i18nKey="description.part35"> Rezerviši </Trans>
                          </button>
                      </Link>
                    </div>
                  </div>
