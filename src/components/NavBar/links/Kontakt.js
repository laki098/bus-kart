      ...
      <header>
        ...
        <div className="contact row1">
          <div className="contact_prikaz">
            ...
            <div className="podaci" style={{paddingLeft: "10%", overflowX:"auto"}}>       {/* 35% u paddingLeft bilo */}

                  <h4><Trans i18nKey="description.part110">Kontakt </Trans></h4> <br/>
                              
                  <h6><Trans i18nKey="description.part111">Adresa:</Trans></h6> <h6> Jug Bogdanova, Kruševac</h6> <br/>
                  <h6><Trans i18nKey="description.part112">Telefon: </Trans></h6>
